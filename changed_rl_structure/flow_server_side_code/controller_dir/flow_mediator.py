...
class Flow_Mediator(object):
    ...
    __FLOW_PRIORITIES = [0, 2, 6]     # follws Linux
    ...
    def __init__(self, rl_server, ip_addresses,
            controller, wf_type, gen_factory,
            cdf_file, host_index):
    ...
    '''
    def _init_flows(self, host, rl_server,
        ...
        while not self._m_exit.is_set():
            ...
            try:
                while 1:
                    ...
                    cm_flow = self._m_cm_flows.get(block=False)
                    send_done_flows.append(cm_flow.get_attributes())
